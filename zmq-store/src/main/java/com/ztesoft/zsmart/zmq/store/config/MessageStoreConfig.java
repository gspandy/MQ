...
import com.ztesoft.zsmart.zmq.store.ConsumeQueue;
...
public class MessageStoreConfig {
    ...
    // 写消息索引到ConsumeQueue 缓存高水位 超过则开始流控
    ...
    // 非可靠模式下，异常宕机恢复快
    @ImportantField
    private boolean messageIndexSafe = true;
    ...
    private int haSlaveFallbehindMax = 1024 * 1024 * 1024;
