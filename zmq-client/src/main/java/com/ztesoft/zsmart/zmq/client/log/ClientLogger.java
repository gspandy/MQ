 ...
 */
package com.ztesoft.zsmart.zmq.client.log;
...
public class ClientLogger {
    ...
    private static Logger createLogger(final String loggerName) {
        String logConfigFilePath =
                System.getProperty("zmq.client.log.configFile",
                        System.getenv("ZMQ_CLIENT_LOG_CONFIGFILE"));
        Boolean isloadconfig =
                Boolean.parseBoolean(System.getProperty("zmq.client.log.loadconfig", "true"));

        final String log4j_resource_file =
                System.getProperty("zmq.client.log4j.resource.fileName", "log4j_rocketmq_client.xml");

        final String logback_resource_file =
                System
                        .getProperty("zmq.client.logback.resource.fileName", "logback_rocketmq_client.xml");
