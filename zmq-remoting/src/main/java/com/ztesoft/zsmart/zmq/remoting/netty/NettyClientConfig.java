...
public class NettyClientConfig {
	...
	private int clinetCallbackExecutorThread = Runtime.getRuntime().availableProcessors();
	...
	public int getClinetCallbackExecutorThread() {
        return clinetCallbackExecutorThread;
    }

    public void setClinetCallbackExecutorThread(int clinetCallbackExecutorThread) {
        this.clinetCallbackExecutorThread = clinetCallbackExecutorThread;
    }
