...
public class NettySystemConfig {
	...
	public static final boolean NettyPooledByteBufAllocatorEnable = Boolean
			.parseBoolean(System.getProperty(SystemPropertyNettyPoolByteBufferAllocatorEnable, "false"));

	public static final String SystemPropertySocketSndbufSize = "com.zmq.remoting.socket.sndbuf.size";

	public static final int SocketSndbufSize = Integer
			.parseInt(System.getProperty(SystemPropertySocketSndbufSize, "65535"));

	public static final String SystemPropertySocketRcvbufSize = "com.zmq.remoting.socket.rcv.buf.size";

	public static final int SocketRcvbufSize = Integer
			.parseInt(System.getProperty(SystemPropertySocketRcvbufSize, "65535"));

	public static final String SystemPropertyClientAsyncSemaphoreValue = "com.zmq.remoting.clientAsyncSemaphoreValue";

	public static final int ClientAsyncSemaphoreValue = Integer
			.parseInt(System.getProperty(SystemPropertyClientAsyncSemaphoreValue, "2048"));
	...
	public static int ClientOnewaySemaphoreValue = Integer
			.parseInt(System.getProperty(SystemPropertyClientOnewaySemaphoreValue, "2048"));
