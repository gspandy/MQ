...
import com.ztesoft.zsmart.zmq.broker.longpolling.PullRequest;
...
import com.ztesoft.zsmart.zmq.broker.pagecache.ManyMessageTransfer;
...
import com.ztesoft.zsmart.zmq.common.filter.FilterAPI;
...
import com.ztesoft.zsmart.zmq.common.protocol.topic.OffsetMovedEvent;
import com.ztesoft.zsmart.zmq.common.subscription.SubscriptionGroupConfig;
import com.ztesoft.zsmart.zmq.common.sysflag.PullSysFlag;
...
import com.ztesoft.zsmart.zmq.store.GetMessageResult;
    ...
    private RemotingCommand processRequest(final Channel channel, RemotingCommand request,
        ...
        if (getMessageResult != null) {
            ...
            if (getMessageResult.isSuggestPullingFromSlave()) {
                responseHeader
                    .setSuggestWhichBrokerId(subscriptionGroupConfig.getWhichBrokerWhenConsumeSlowly());
            }
            // 消费正常，按照订阅组配置重定向
            else {
            ...
            case ResponseCode.SUCCESS:
                ...
                this.brokerController.getBrokerStatsManager()
                    .incBrokerGetNums(getMessageResult.getMessageCount());
