...
public class MixAll {
    public static final String ZMQ_HOME_ENV = "ZMQ_HOME";

    public static final String ZMQ_HOME_PROPERTY = "zmq.home.dir";

    public static final String NAMESRV_ADDR_ENV = "NAMESRV_ADDR";

    public static final String NAMESRV_ADDR_PROPERTY = "zmq.namesrv.addr";

    public static final String MESSAGE_COMPRESS_LEVEL = "zmq.message.compressLevel";

    public static final String WS_DOMAIN_NAME = System.getProperty("zmq.namesrv.domain", "jmenv.ztesoft.com");

    public static final String WS_DOMAIN_SUBGROUP = System.getProperty("zmq.namesrv.domain.subgroup", "nsaddr");
