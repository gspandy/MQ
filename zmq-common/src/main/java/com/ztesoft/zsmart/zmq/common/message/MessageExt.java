...
public class MessageExt extends Message {
     ...
     * serialVersionUID <br>
     */
    private static final long serialVersionUID = -3995430876726279132L;
    ...
    public String toString() {
        return "MessageExt [queueId=" + queueId + ", storeSize=" + storeSize + ", queueOffset=" + queueOffset
            ...
            + ", commitLogOffset=" + commitLogOffset + ", bodyCRC=" + bodyCRC + ", reconsumeTimes=" + reconsumeTimes
            + ", preparedTransactionOffset=" + preparedTransactionOffset + ", toString()=" + super.toString() + "]";
    }
}
