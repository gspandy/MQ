package com.ztesoft.zsmart.zmq.common.protocol.route;
 ...
 * @since V7.3<br>
 * @see com.ztesoft.zsmart.zmq.common.protocol.route <br>
 */
public class TopicRouteData extends RemotingSerializable {
    ...
    private HashMap<String/* broderAddr */, List<String>/* Filter Server */> filterServerTable = new HashMap<String, List<String>>();
